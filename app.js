...
function renderPac(){
  ...
  el.innerHTML=D.pac.map((p,pi)=>{
    ...
    const acoesRows=p.acoes.map((a,ai)=>`
      <tr>
        <td contenteditable="true" onblur="D.pac[${pi}].acoes[${ai}].acao=this.textContent;saveD(true)" style="padding:7px 10px;font-size:.76rem;color:var(--white);border-bottom:1px solid rgba(255,255,255,.05);word-break:break-word;max-width:0">${a.acao||''}</td>
        <td contenteditable="true" onblur="D.pac[${pi}].acoes[${ai}].resp=this.textContent;saveD(true)" style="padding:7px 10px;font-size:.76rem;color:var(--g200);border-bottom:1px solid rgba(255,255,255,.05);word-break:break-word;max-width:0">${a.resp||''}</td>
        <td contenteditable="true" onblur="D.pac[${pi}].acoes[${ai}].prazo=this.textContent;saveD(true)" style="padding:7px 10px;font-size:.76rem;color:var(--g400);border-bottom:1px solid rgba(255,255,255,.05);word-break:break-word">${a.prazo||''}</td>
    ...
    <div class="card" style="margin-bottom:20px;padding:0;overflow:hidden;overflow-x:auto">
      ...
      <div style="padding:18px">
        <div style="margin-bottom:18px">
          ...
          <div style="display:grid;grid-template-columns:120px 1fr 1fr 1fr;gap:12px">
            ${['soc:SOC (%)','sellin:Evolução Sell-in (últ. 3 anos)','sellout:Evolução Sell-out (últ. 3 anos)','estoque:Estoque'].map(f=>{
              const [key,lbl]=f.split(':');
              return '<div><div style="font-size:.65rem;color:var(--g400);font-weight:700;margin-bottom:4px">'+lbl+'</div>'
                +'<div contenteditable="true" onblur="D.pac['+pi+'].'+key+'=this.textContent;saveD(true)" style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:6px;padding:8px 10px;font-size:.8rem;color:var(--white);min-height:60px;max-height:120px;overflow-y:auto;outline:none;word-break:break-word">'+( p[key]||'')+'</div></div>';
            }).join('')}
          </div>
        </div>
        <!-- PARTE 2 & 3 -->
        <div style="display:flex;flex-direction:column;gap:16px">
          ...
          <div>
            ...
            <table style="width:100%;border-collapse:collapse">
              <thead><tr style="background:rgba(255,255,255,.05)">
                <th style="padding:6px 10px;font-size:.65rem;color:var(--g400);text-align:left;width:40%">Item</th>
                <th style="padding:6px 10px;font-size:.65rem;color:var(--g400);text-align:left;width:25%">Resp.</th>
                <th style="padding:6px 10px;font-size:.65rem;color:var(--g400);text-align:left;width:15%">Prazo</th>
          ...
          <div>
            ...
            <table style="width:100%;border-collapse:collapse">
              <thead><tr style="background:rgba(255,255,255,.05)">
                <th style="padding:6px 10px;font-size:.65rem;color:var(--g400);text-align:left;width:40%">Ação</th>
                <th style="padding:6px 10px;font-size:.65rem;color:var(--g400);text-align:left;width:25%">Resp.</th>
                <th style="padding:6px 10px;font-size:.65rem;color:var(--g400);text-align:left;width:15%">Prazo</th>
                <th style="padding:6px 10px;font-size:.65rem;color:var(--g400);text-align:left;width:12%">Status</th>
                <th style="width:32px"></th>

...
const ONEPAGE_DATA={
  'INTEGRADA':{
    ...
    sellinMix:{label:'Sell-in mix by category (2025)',center:'$10M',centerSub:'2025',items:[
      ...
      {n:'F&V, Coffee & Citrus (0.2)',v:0.2,c:'#C9B27C'},{n:'Other (0.0)',v:0.02,c:'#333'}]},
  ...
  'COAMO':{
    ...
    sellin:{label:'Sell-in trend & 2026 target (YTD realized)',years:['2023','2024','2025'],vals:[45.4,20.6,24.0],target:34,ytd:23,ytdPct:'68%',max:60,ticks:[0,15,30,45,60]},
    ...
    soc:{label:'SOC - Crop Protection',items:[
      {n:'Bayer',v:35,c:'#B85C4A'},{n:'BASF',v:20,c:'#1F3B57'},
      {n:'Syngenta',v:15,c:'#4A8FA0'},{n:'UPL',v:12,c:'#C9A227'},
      {n:'Corteva',v:10,c:'#2A9D8F',hl:true}],max:50},
    takeaway:'Sell-in +17% in 2025 (-27% CAGR from 2023); sell-out targeted +131% to $85M by 28/29; inventory high (49% of sell-out, >30% healthy line).<br>Challenge: 2026 sell-in target $34M is +40% vs 2025 — stock must sell down first while stock is high.'
  },
  'COPLACANA':{
    channel:'CHANNEL · COOPERATIVE · ESCALA MINDCOOP',
    title:'Coplacana',logo:'COPLACANA',logoSub:'COOPERATIVA DOS PLANTADORES',
    sellin:{label:'Sell-in trend & 2026 target (YTD realized)',years:['2023','2024','2025'],vals:[30.9,35.3,42.0],target:45,ytd:10,ytdPct:'23%',max:60,ticks:[0,15,30,45,60]},
    sellinMix:{label:'Sell-in mix by category (2025)',center:'$42M',centerSub:'2025',items:[
      ...
      {n:'Biologicals (0.4)',v:0.4,c:'#C9B27C'},{n:'Other (0.2)',v:0.2,c:'#333'}]},
    ...
    actionPlan:[
      ...
      '<b>Detailed planning for expansion regions</b>, with emphasis on the Midwest.',
      '<b>Selection of priority branches</b>, segmentation of cooperative members, definition of products, targets, and action plan by branch.'
    ],
    soc:{label:'SOC - Crop Protection',items:[
  ...
  'LAR':{
    ...
    sellinMix:{label:'Sell-in mix by category (2025)',center:'$25M',centerSub:'2025',items:[
      ...
      {n:'Pasture & IVM (0.3)',v:0.3,c:'#C9B27C'},{n:'Other (0.1)',v:0.1,c:'#333'}]},
    sellout:{label:'Sell-out — history, targets & 26/27 YTD',cats:['23/24','24/25','25/26','26/27 T','27/28 T','28/29 T'],vals:[27,16,23,36,44,52],histCount:3,ytdIdx:3,ytdVal:4,max:60,ticks:[0,15,30,45,60]},
    ...
    actionPlan:[
      ...
      '<b>Balance participation in key branches</b>, concentrating targets in medium-share units. Detailed planning in expansion regions.',
    ...
    takeaway:'Sell-in +94% in 2025 (+4% CAGR from 2023); sell-out targeted +230% to $52M by 28/29; inventory high (129% of sell-out, >30% healthy line).<br>Challenge: 2026 sell-in target $21M is -16% vs 2025 — a reset to clear inventory while stock is high.'
  },
  'COOPERCITRUS':{
    channel:'CHANNEL · COOPERATIVE · MINDCOOP',
    title:'Coopercitrus',logo:'COOPERCITRUS',logoSub:'COOPERATIVA DE PRODUTORES RURAIS',
    sellin:{label:'Sell-in trend & 2026 target (YTD realized)',years:['2023','2024','2025'],vals:[25.4,28.9,25.5],target:33,ytd:0,ytdPct:'0%',max:40,ticks:[0,10,20,30,40]},
    sellinMix:{label:'Sell-in mix by category (2025)',center:'$26M',centerSub:'2025',items:[
      ...
      {n:'Herbicides (1.3)',v:1.3,c:'#C9B27C'},{n:'Other (1.4)',v:1.4,c:'#333'}]},
    sellout:{label:'Sell-out — history, targets & 26/27 YTD',cats:['23/24','24/25','25/26','26/27 T','27/28 T','28/29 T'],vals:[30,30,28,29,30,32],histCount:3,ytdIdx:3,ytdVal:0,max:40,ticks:[0,10,20,30,40]},
    inventory:{pct:36,status:'ABOVE HEALTHY LINE',healthy:30,note:'Inventory july/26 10MUSD  |  Sellout 25/26 28MUSD'},
    actionPlan:[
      '<b>Selection of priority branches</b>, segmentation of cooperative members (Top 20), definition of products, targets, and action plan by branch.',
      '<b>Expansion</b> in soybean, citrus, and coffee crops.',
      '<b>Key products:</b> UTRISHA N ambassador program and demand generation actions for LINEAR and GAPPER.'
    ],
    soc:{label:'SOC - Crop Protection',items:[
    ...
    mix:{"label": "Mix de produto — COAMO 2025", "targetLine": 67, "note": "Estratégico + Lançamento 41%", "items": [{"label": "Lançamento", "v": 12, "c": "#C9A227"}, {"label": "Estratégico", "v": 16, "c": "#4A8FA0"}, {"label": "Regular", "v": 25, "c": "#6B8E4E"}, {"label": "Commodity", "v": 47, "c": "#8B9BAD"}]},
    takeaway:'Sell-in -12% in 2025 (+0% CAGR from 2023); sell-out targeted +7% to $32M by 28/29; inventory above healthy line (36% of sell-out).<br>Challenge: 2026 sell-in target $33M is +28% vs 2025 — stock must sell down first.'
  },
  'COMIGO':{
    channel:'CHANNEL · COOPERATIVE · MINDCOOP',
    ...
    sellinMix:{label:'Sell-in mix by category (2025)',center:'$24M',centerSub:'2025',items:[
      ...
      {n:'Rice (0.5)',v:0.5,c:'#C9B27C'},{n:'Other (0.1)',v:0.1,c:'#333'}]},
    sellout:{label:'Sell-out — history, targets & 26/27 YTD',cats:['23/24','24/25','25/26','26/27 T','27/28 T','28/29 T'],vals:[27,21,20,24,27,32],histCount:3,ytdIdx:3,ytdVal:0,max:40,ticks:[0,10,20,30,40]},
    inventory:{pct:255,status:'ABOVE HEALTHY LINE',healthy:30,note:'Inv 50MUSD  |  Sell-out 25/26 20MUSD'},
    actionPlan:[
      '<b>Commercial Activation & Sell-Out:</b> Drive sales through barter/cross-sell offers, performance bonuses for Sales Consultants, and relationship-building initiatives.',
      '<b>Technical Support & Demand Generation:</b> Deploy 410 Crop Protection demand-generation fields, field days, results tours, and personalized content shared via WhatsApp.',
      '<b>Marketing, Inventory Management & Governance:</b> Strengthen brand and campaigns; optimize stock through DSM; maintain monthly governance forums to track KPIs.'
    ],
    soc:{label:'SOC - Crop Protection (Ranking by Position)',items:[
      {n:'Player 1',v:45,c:'#6B8E3F'},{n:'Corteva',v:35,c:'#2A9D8F',hl:true},
      {n:'Player 3',v:25,c:'#1F3B57'},{n:'Player 4',v:15,c:'#C9A227'},
      {n:'Player 5',v:10,c:'#B85C4A'}],max:50},
    mix:{"label": "Mix de produto — COPLACANA 2025", "targetLine": 67, "note": "Estratégico + Lançamento 65%", "items": [{"label": "Lançamento", "v": 14, "c": "#C9A227"}, {"label": "Estratégico", "v": 21, "c": "#4A8FA0"}, {"label": "Regular", "v": 16, "c": "#6B8E4E"}, {"label": "Commodity", "v": 49, "c": "#8B9BAD"}]},
    mix:{"label": "Mix de produto — LAR 2025", "targetLine": 67, "note": "Estratégico + Lançamento 44%", "items": [{"label": "Lançamento", "v": 11, "c": "#C9A227"}, {"label": "Estratégico", "v": 10, "c": "#4A8FA0"}, {"label": "Regular", "v": 34, "c": "#6B8E4E"}, {"label": "Commodity", "v": 45, "c": "#8B9BAD"}]},
    takeaway:'Sell-in 2025 US$23.8M (-24% vs 2024); sell-out 25/26 US$19.8M, targeted to US$32.0M by 28/29; inventory 255% of sell-out (>30%, above healthy line).<br>Challenge: 2026 sell-in target US$20.2M vs 2025 US$23.8M (-15%); 2026 YTD invoiced+orders US$13.5M.'
  },
  'CVALE':{
    channel:'CHANNEL · COOPERATIVE · MINDCOOP',
    title:'C.Vale',logo:'C.VALE',logoSub:'COOPERATIVA AGROINDUSTRIAL',
    sellin:{label:'Sell-in trend & 2026 target (YTD realized)',years:['2023','2024','2025'],vals:[21.2,16.6,22.0],target:23,ytd:5,ytdPct:'32%',max:30,ticks:[0,10,20,30]},
    sellinMix:{label:'Sell-in mix by category (2025)',center:'$22M',centerSub:'2025',items:[
      ...
      {n:'Biologicals (0.5)',v:0.5,c:'#C9B27C'},{n:'Other (0.2)',v:0.2,c:'#333'}]},
    sellout:{label:'Sell-out — history, targets & 26/27 YTD',cats:['23/24','24/25','25/26','26/27 T','27/28 T','28/29 T'],vals:[31,20,24,29,34,44],histCount:3,ytdIdx:3,ytdVal:0,max:50,ticks:[0,12,24,36,50]},
    inventory:{pct:45,status:'ABOVE HEALTHY LINE',healthy:30,note:'Inv 11MUSD  |  Sell-out 25/26 24MUSD'},
    actionPlan:[
      '<b>Sales Tracking:</b> Continuous sales monitoring and route adjustments — macro tracking, quarterly strategic reviews, pulse follow-ups, and a weekly ranking (KAM/DSM, every 7–30 days).',
      '<b>Sales Enablement:</b> Team training and quarterly product-focused sales pushes (Ligar, Exalt, Paxeo, Elevore, Ulrisha, etc.), supported by a full-year technical plan aligned with agronomy.',
      '<b>Field Demos & Influencers:</b> Technical tours and influencer projects across summer and safrinha to prove results and engage key growers.'
    ],
    soc:{label:'SOC - Crop Protection',items:[
    ...
    mix:{"label": "Mix de produto — COOPERCITRUS 2025", "targetLine": 67, "note": "Estratégico + Lançamento 74%", "items": [{"label": "Lançamento", "v": 8, "c": "#C9A227"}, {"label": "Estratégico", "v": 18, "c": "#4A8FA0"}, {"label": "Regular", "v": 21, "c": "#6B8E4E"}, {"label": "Commodity", "v": 53, "c": "#8B9BAD"}]},
    takeaway:'Sell-in 2025 US$22.0M (+32% vs 2024); sell-out 25/26 US$24.0M, targeted to US$43.7M by 28/29; inventory 45% of sell-out (>30%, above healthy line).<br>Challenge: 2026 sell-in target US$0.1M vs 2025 US$22.0M (-100%); 2026 YTD invoiced+orders US$4.7M.'
  },
  'COTRIJAL':{
    channel:'CHANNEL · COOPERATIVE · MINDCOOP',
    ...
    mix:{"label": "Mix de produto — COMIGO 2025", "targetLine": 67, "note": "Estratégico + Lançamento 27%", "items": [{"label": "Lançamento", "v": 15, "c": "#C9A227"}, {"label": "Estratégico", "v": 13, "c": "#4A8FA0"}, {"label": "Regular", "v": 14, "c": "#6B8E4E"}, {"label": "Commodity", "v": 59, "c": "#8B9BAD"}]},
    mix:{"label": "Mix de produto — C.VALE 2025", "targetLine": 67, "note": "Estratégico + Lançamento 41%", "items": [{"label": "Lançamento", "v": 5, "c": "#C9A227"}, {"label": "Estratégico", "v": 21, "c": "#4A8FA0"}, {"label": "Regular", "v": 20, "c": "#6B8E4E"}, {"label": "Commodity", "v": 53, "c": "#8B9BAD"}]},
...
function opMixHTML(d){
  ...
  const maxV = Math.max(...d.items.map(i=>i.v));
  const bars = d.items.map(it=>{
    const pct = (it.v/maxV*80).toFixed(1);
    return `<div style="display:flex;flex-direction:column;align-items:center;flex:1;gap:4px">
      <div style="font-size:.68rem;font-weight:700;color:${it.c}">${it.v}%</div>
      <div style="position:relative;width:100%;height:80px;display:flex;align-items:flex-end">
        <div style="width:100%;height:${pct}%;background:${it.c};border-radius:3px 3px 0 0;min-height:4px"></div>
      </div>
      <div style="font-size:.6rem;color:var(--g400);text-align:center;line-height:1.3">${it.label}</div>
    </div>`;
  }).join('');
  const legend = d.items.map(it=>`<div style="display:flex;align-items:center;gap:5px;font-size:.62rem;color:var(--g300)"><span style="width:10px;height:3px;background:${it.c};display:inline-block;border-radius:2px"></span>${it.label}</div>`).join('');
  return `<div>
    <div style="font-size:.62rem;color:var(--g400);margin-bottom:6px">${d.label||'Mix de produto'}</div>
    ${d.targetLine?`<div style="font-size:.6rem;color:#E05050;margin-bottom:4px">--- Target Corteva ${d.targetLine}%</div>`:''}
    <div style="display:flex;gap:4px;align-items:flex-end;height:100px;padding:0 4px">${bars}</div>
    <div style="font-size:.6rem;color:var(--g400);margin-top:6px">${d.note||''}</div>
  </div>`;
}
